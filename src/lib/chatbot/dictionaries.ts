...
export const ABBREVIATIONS: Record<string, string> = {
  ...
  ily: 'eu te amo', xoxo: 'beijos e abraços', ty: 'obrigado', thx: 'obrigado', tyvm: 'muito obrigado', yw: 'de nada',
  ...
  ping: 'latência', dc: 'desconectado', g2g: 'tenho que ir', cya: 'até logo', l8r: 'mais tarde',
  b4: 'antes', 2: 'para', 4: 'por', u: 'você', r: 'são', 'w/': 'com', 'w/o': 'sem',
  'n/a': 'não aplicável', jk: 'brincadeira',
  hj: 'hoje', amanh: 'amanhã',
  smp: 'sempre', nnc: 'nunca', alg: 'alguém', ngm: 'ninguém', td: 'tudo',
  qnd: 'quando', cm: 'como', qm: 'quem', ql: 'qual', qnt: 'quanto',
  onde: 'onde', aq: 'aqui', ali: 'ali', la: 'lá', agr: 'agora', ja: 'já',
  pco: 'pouco', '=': 'igual',
